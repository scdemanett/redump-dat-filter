...
- Installers: `redump-dat-filter-setup-{VERSION}-{PLATFORM}.{ext}` (e.g. `redump-dat-filter-setup-0.3.1-win-x64.exe`)
- Portable builds: `redump-dat-filter-unpacked-{VERSION}-{PLATFORM}.zip` (e.g. `redump-dat-filter-unpacked-0.3.1-mac-arm64.zip`)
